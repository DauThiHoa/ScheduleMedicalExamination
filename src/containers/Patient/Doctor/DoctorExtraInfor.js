...
class DoctorExtraInfor extends Component {
    ...
    constructor(props) {
        super (props);
        this.state = {
            // Bien an hien xem chi tiet dia chi phong kham
    ...
    // Hien thi thong tin chi tiet cua bac si
                  ...
                  <div className='content-down'>
                    ...
                    {isShowDetailInfor === false &&
                      <div className='short-infor'>
                             ...
                             {/* Neu co gia tri - Co gia tri trong bien - ngon ngu anh */}
                             {extraInfor && extraInfor.priceTypeData && language === LANGUAGES.VI 
                             &&  
                          
                             <NumberFormat 
                             className='currency'
                                value={extraInfor.priceTypeData.valueVn}
                                displayType={'text'} 
                      ...
                      <>
                        ...
                        <div className='detail-infor'>
                         ...
                         <div className='payment'>
                            ...
                            ? 
                            extraInfor.paymentTypeData.valueVn : ''}
