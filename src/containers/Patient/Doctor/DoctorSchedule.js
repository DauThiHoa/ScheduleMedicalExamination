...
class DoctorSchedule extends Component {
    ...
    async  componentDidUpdate ( prevProps, prevState , snapshot) {
        if (this.props.language !== prevProps.language){  
            ...
            console.log ('HOI DAN IT :allDays ',allDays )
            this.setState ({
                allDays : allDays
            })
        }
    ...
    handleOnChangeSelect = async (event) => {
        console.log (' this.props.match.params.id : ', this.props.doctorIdFromParent)
        if ( this.props.doctorIdFromParent && this.props.doctorIdFromParent !== -1){
            ...
            console.log ( 'getScheduleDoctorByDate : ',  res.data.errCode)
            console.log ( 'getScheduleDoctorByDate : ',  res.data)
        } 
    }

    handleClickScheduleTime = async (time ) => {
        this.setState ({
            // Bam vao nut thoi gian => Tu dong hien thi Modal Booking
